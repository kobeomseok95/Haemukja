      ...
      <div class="col-lg-9">
        ...
        <div class="container">
          <div class="center-block">
          	<%if (qna == null) { // 게시글을 쓰는경우%>
            <form id="productExplainForm" method="post" action="<%=request.getContextPath()%>/write.qn">
            ...
            <%} else { // 게시글을 수정하는 경우%>
            <form id="productExplainForm" method="post" action="<%=request.getContextPath()%>/update.qn?qid=<%=qna.getQid()%>">
              <label for="title"><h5>제목 : </h5></label>
              <input type="text" name="title" style="width: 740px" value=<%=qna.getQtitle()%> />
              <br><br>
              <textarea name="content" cols="110" rows="30"><%=qna.getQcontent()%></textarea>
              <br><br>
